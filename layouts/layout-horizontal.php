 ...
 * @return String
 **/
function ucf_spotlight_display_horizontal( $content='', $item = null, $args = array() ) {
	...
	ob_start();
?>
	<aside role="note" class="spotlight spotlight-horizontal py-5 <?php if ( $img ) { echo 'media-background-container'; } ?>">
		<?php if ( $img ) { echo $img; } ?>
		<div class="container">
			<div class="row">
				<div class="col-lg-8">
